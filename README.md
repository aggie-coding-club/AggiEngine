[![Build Status](https://img.shields.io/github/actions/workflow/status/aggie-coding-club/AggiEngine/.github/workflows/main.yml?branch=master)](https://github.com/aggie-coding-club/AggiEngine/actions)
